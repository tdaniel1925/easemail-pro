      ...
      try {
        ...
        await db.update(contactSyncStatus)
          .set({
            ...
            totalContactsSynced: syncStatus.totalContactsSynced + allContacts.length,
            contactsAdded: syncStatus.contactsAdded + results.contactsAdded,
            contactsUpdated: syncStatus.contactsUpdated + results.contactsUpdated,
            contactsSkipped: syncStatus.contactsSkipped + results.contactsSkipped,
            syncError: null,
            updatedAt: new Date(),
          })
          .where(eq(contactSyncStatus.id, syncStatus.id));
