  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell:
          "text-muted-foreground rounded-md flex-1 font-normal text-[0.75rem] flex items-center justify-center",
        ...
        day: cn(
          ...
          "h-8 w-8 p-0 font-normal aria-selected:opacity-100 text-sm hover:bg-accent hover:text-accent-foreground"
        ),
