...
export class ContactsV4SyncService {
  ...
  private transformFromNylas(nylas: NylasContact): Partial<ContactV4> {
    return {
      given_name: nylas.given_name || null,
      middle_name: nylas.middle_name || null,
      surname: nylas.surname || null,
      suffix: nylas.suffix || null,
      nickname: nylas.nickname || null,
      emails: nylas.emails || [],
      phone_numbers: nylas.phone_numbers || [],
      physical_addresses: nylas.physical_addresses || [],
      web_pages: nylas.web_pages || [],
      im_addresses: nylas.im_addresses || [],
      job_title: nylas.job_title || null,
      company_name: nylas.company_name || null,
      manager_name: nylas.manager_name || null,
      office_location: nylas.office_location || null,
      department: nylas.department || null,
      birthday: nylas.birthday ? new Date(nylas.birthday) : null,
      notes: nylas.notes || null,
      picture_url: nylas.picture_url || null,
      groups: nylas.groups || [],
      sync_status: 'synced',
    };
  }
  ...
  private transformToNylas(local: Partial<ContactV4>): Partial<NylasContact> {
    return {
      given_name: local.given_name || undefined,
      middle_name: local.middle_name || undefined,
      ...
      physical_addresses: local.physical_addresses || [],
      web_pages: local.web_pages || [],
      im_addresses: local.im_addresses || [],
      job_title: local.job_title || undefined,
      company_name: local.company_name || undefined,
      manager_name: local.manager_name || undefined,
      office_location: local.office_location || undefined,
