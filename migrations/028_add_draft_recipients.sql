...
-- Purpose: Add to_recipients, cc, bcc columns for draft recipients
-- Date: 2025-11-04
-- Updated: 2025-11-04 - Renamed 'to' to 'to_recipients' to avoid reserved keyword
...
-- Add comments
COMMENT ON COLUMN email_drafts.to_recipients IS 'To recipients as JSON array of {email, name}';
